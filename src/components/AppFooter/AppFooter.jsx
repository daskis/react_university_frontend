		...
		<div className="footer mt-20 overflow-hidden relative">
			...
			<div className="relative">
				<div className="relative bg-footerFirst bg-no-repeat bg-top">
					<div className="container flex justify-between items-center">
						<div className="py-20 text-4xl text-white font-bold text-justify w-[50%]">
							...
							<p className="flex items-center mt-48 text-4xl text-white font-bold"><img className="pr-4"
							                                                                          src={phone}
							                                                                          alt=""/>8 800
								222-26-73</p>

							<p className="flex items-center mt-4 text-base font-semibold underline"><img
								className="pr-4" src={mail} alt=""/>info@drupal-coder.ru</p>
				...
				<div className="py-10 border-t-2 border-white border-opacity-20 relative">
					...
					<img src={logo} className="absolute right-0 -top-20" alt=""/>
				</div>
			</div>
