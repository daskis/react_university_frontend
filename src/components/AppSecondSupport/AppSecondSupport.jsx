...
const AppSecondSupport = () => {
	return (
		<div className="container relative z-40">
			<h1 className="text-secondary font-bold text-4xl text-center mb-16">Поддержка <br/>от Drupal-coder</h1>
			<ul className=" right-0 left-0 top-80 flex justify-between flex-wrap">
				<li className="p-6 rounded-lg w-1/4 shadow-sm flex-col relative z-40">
