...
<div class="grid grid-flow-row auto-rows-max md:auto-rows-min grid-cols-5 gap-8">
  <div class="transform scale-75 p-12 max-w-sm md-auto bg-white flex items-center border">
